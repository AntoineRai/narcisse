    ...
    <header className="w-full absolute top-0 left-0 z-50 bg-transparent">
      <div className="max-w-[2100px] mx-auto px-4 lg:px-32 py-8 flex items-center justify-between">
        ...
        <button 
          ...
          className={`2xl:hidden ${isContact ? 'text-black' : 'text-white'}`}
        >
          <svg 
        ...
        {/* Menu mobile */}
        {isMenuOpen && (
          <div className="2xl:hidden absolute top-full left-0 right-0 bg-black bg-opacity-95 p-4 z-50">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <a 
                  href="https://www.tiktok.com/@narcisseprojet" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white hover:text-gray-300 transition-colors"
                >
                ...
                <a 
                  href="https://www.facebook.com/profile.php?id=61567367669025" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white hover:text-gray-300 transition-colors"
                >
